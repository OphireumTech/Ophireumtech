...
export const COLLECTIONS = {
  ...
  mt5Bindings: 'mt5Bindings',
  mt5Workers: 'mt5Workers',
  mt5AccountSnapshots: 'mt5AccountSnapshots',
  mt5Positions: 'mt5Positions',
  mt5Orders: 'mt5Orders',
  mt5Deals: 'mt5Deals',
  executionRequests: 'executionRequests',
  executionResults: 'executionResults',
  accountHeartbeats: 'accountHeartbeats',
  ...
  bindingAuditLogs: 'bindingAuditLogs',
